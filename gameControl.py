...
while camera_video.isOpened():
        ...
        if checkHandsJoined(frame, results)[1] == 'Hands Joined':
            ...
            if counter == num_of_frames:
                ...
                # Otherwise if the game has started.
                    ...
                    # print("Hands joined! Switching to game control...")
    ...
    if (time2 - time1) > 0:
        ...
        cv2.putText(frame, 'FPS: {}'.format(int(frames_per_second)), (10, 30),cv2.FONT_HERSHEY_COMPLEX_SMALL, 2, (0, 255, 0), 3)
